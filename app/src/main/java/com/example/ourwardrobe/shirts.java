...
public class shirts extends AppCompatActivity {
    ...
    public void ShowDialogBox(Bitmap item_pos){
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (btnAdd.isChecked()) {
                    Toast.makeText(shirts.this, "Cloth is added to Outfit Creator", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(shirts.this, "Cloth is removed from Outfit Creator", Toast.LENGTH_SHORT).show();
                }
            }
        });
