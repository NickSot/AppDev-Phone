...
public class dresses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GetClothesRequest request = new GetClothesRequest(ApplicationContext.getInstance().getWardrobe().getwId(), "Dress");
    ...
    public void ShowDialogBox(Bitmap item_pos){
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (btnAdd.isChecked()) {
                    Toast.makeText(dresses.this, "Cloth is added to Outfit Creator", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(dresses.this, "Cloth is removed from Outfit Creator", Toast.LENGTH_SHORT).show();
                }
            }
        });
